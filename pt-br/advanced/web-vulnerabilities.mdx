...
O **OWASP (Open Worldwide Application Security Project, ou Projeto Aberto de Segurança de Aplicações Web)** mantém a lista padrão da indústria dos riscos mais críticos.
